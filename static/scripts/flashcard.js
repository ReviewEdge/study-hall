(() => {
  window.addEventListener("DOMContentLoaded", function() {
    ...
    // delete flashcard
    deleteBtn = document.getElementById("delete-flashcard")
    if (deleteBtn) {
  ...
  function insertFlashcard(flashcard) {
      ...
      const deleteBtn = fDiv.getElementsByClassName("delete-flashcard")[0];
      deleteBtn.addEventListener("click", e => deleteFlashcard(flashcard.id, e.target))
